...
<div class="container">
  <div class="row">
    ...
    <div class="col-sm-3">
      <div class="card" >
  <img class="card-img-top" src="images/pexels-pixabay-70573.jpg" alt="Card image cap">
  <div class="card-body">
    ...
    <div class="col-sm-3">
      <div class="card" >
  <img class="card-img-top" src="images/istockphoto-472171577-612x612.jpg" alt="Card image cap">
  <div class="card-body">
    ...
    <a href="#" class="btn btn-danger">Read More</a>
      ...
      <div class="card" >
  <img class="card-img-top" src="images/pexels-pok-rie-33563-14823600.jpg" alt="Card image cap">
  <div class="card-body">
    ...
    <div class="col-sm-3">
      <div class="card" >
        <img class="card-img-top" src="images/pexels-gustavo-fring-7156160.jpg" alt="Card image cap">
        <div class="card-body">
